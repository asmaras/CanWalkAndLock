...
namespace PlatformSpecific
{
    ...
    public:
        ...
        uint16_t IPsNvsGetUint16(const NvsHandle handle, const char(&key)[PlatformSpecific::INvs::Input::keyLength], uint16_t defaultValue) override;
        void IPsNvsSetUint16(const NvsHandle handle, const char(&key)[PlatformSpecific::INvs::Input::keyLength], uint16_t value) override;
    };
