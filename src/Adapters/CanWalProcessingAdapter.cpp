...
extern const short goFastRawStart[] = {}; //asm("_binary_SoundResources_goFast_raw_start");
extern const short goFastRawEnd[] = {}; //asm("_binary_SoundResources_goFast_raw_end");
extern const short intermediateCountdownRawStart[] = {}; //asm("_binary_SoundResources_intermediateCountdown_raw_start");
extern const short intermediateCountdownRawEnd[] = {}; //asm("_binary_SoundResources_intermediateCountdown_raw_end");

void CanWalProcessingAdapter::IPiSoundPlaySound(PlatformIndependent::Commons::ISound::Output::Sound sound)
{
    switch (sound)
    {
    case PlatformIndependent::Commons::ISound::Output::Sound::goFast:
        _iPsSoundPlayer->IpsSoundPlayerPlaySound(goFastRawStart, goFastRawEnd - goFastRawStart);
        break;
    case PlatformIndependent::Commons::ISound::Output::Sound::intermediateCountdown:
        _iPsSoundPlayer->IpsSoundPlayerPlaySound(intermediateCountdownRawStart, intermediateCountdownRawEnd - intermediateCountdownRawStart);
        break;
    default:
        break;
    }
